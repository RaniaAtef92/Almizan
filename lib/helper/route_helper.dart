...
import 'package:efood_multivendor/view/screens/contract_screen/contract_screen.dart';
...
class RouteHelper {
  ...
  static String getContractRoute() => '$contractScreen';
  ...
  static List<GetPage> routes = [
    ...
    GetPage(name: contractScreen, page: () => getRoute(ContractScreen())),
    GetPage(
        name: main,
